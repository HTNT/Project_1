...
const UserConversation = (props) => {
    ...
    const handleSubmit = async (e) => {
        try {
            ...
            const result = await conversationAPI.sendMessages(
                tokenUser,
                iuser._id,
                body
            );
    ...
    return (
        <div className="message">
            <div className="message__header">
                <div className="message__header-avt">
                    <img
                        className="message__header-avt_img"
                        src={user.avatar}
                    ></img>
                </div>
                ...
                <div className="message__header-name">
                    ...
                    <div
                        className="message__header-close"
                        onClick={() => {
            ...
            <div className="message__input">
                ...
                ></input>
                <div className="message__input-submit" onClick={handleSubmit}>
                    <IoIosSend
                        style={{
                            width: "100%",
                            height: "100%",
